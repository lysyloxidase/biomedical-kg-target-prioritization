...
class GraphSAGEEncoder(nn.Module):
    ...
    def __init__(
        self, hidden_channels: int, num_layers: int, metadata: Metadata
    ) -> None:
        super().__init__()
    ...
    def forward(
        ...
        for conv in self.convs:
            ...
            z_dict = {
                node_type: z_next.get(node_type, z_dict[node_type]).relu()
...
class HomogeneousGraphSAGEEncoder(nn.Module):
    ...
    def __init__(
        self, hidden_channels: int, num_layers: int, node_types: list[str]
    ) -> None:
        super().__init__()
